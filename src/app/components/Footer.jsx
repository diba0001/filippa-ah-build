      ...
      <div className="max-w-4xl mx-auto px-4 mt-24">
        <div className="flex flex-col items-center space-y-2 md:hidden">
          <a
            ...
            className="text-xs hover:line-through transition-all focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 rounded px-2 py-1"
          >
            +45 50708507
          </a>
          ...
          <Link 
            ...
            className="hover:line-through transition-all focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 rounded p-2"
          >
        ...
        <div className="hidden md:flex md:items-center md:justify-center md:space-x-2">
          <a
            href="tel:+4550708507"
            aria-label="Call +45 50708507"
            className="text-xs hover:line-through transition-all focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 rounded px-2 py-1"
